...
const leftPagination = ({ color }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="32" height="29" viewBox="0 0 284.936 284.936" style={{ fill: color ? color : "" }} space="preserve">
            <g> <g> <g>
